...
public class DebugUI : MonoBehaviour {
	...
	void ReadData() {
		...
		//PLAYER DATA
		healthCtr.text = PlayerPrefs.GetFloat(Constants.PlayerPrefKey.PLAYER_SAVED_HP, 100f).ToString("N0");
		manaCtr.text = PlayerPrefs.GetFloat(Constants.PlayerPrefKey.PLAYER_SAVED_MP, 100f).ToString("N0");
	...
	public void SaveData() {
		...
		PlayerPrefs.SetFloat(Constants.PlayerPrefKey.PLAYER_SAVED_MP, float.Parse(manaCtr.text));
